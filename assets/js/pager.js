...
$(document).ready(function () {
    ...
    //capturing Page
    function checkBoxClassified(){
        var numberOfChecked  = $('.classifiedChk:checked').length;
        if(numberOfChecked >= 2){ 
               $('.two-chkbox-not-selected').removeClass('show').addClass('hide');
               $('.two-chkbox-selected').removeClass('hide').addClass('show');
        }else{
            $('.two-chkbox-not-selected').removeClass('hide').addClass('show');
            $('.two-chkbox-selected').removeClass('show').addClass('hide');
        }
    }
    $('.classifiedChk').click(function(e){
        checkBoxClassified();
    });
    checkBoxClassified();

    //template-view page
    $('.t-report').click(function(e){
        $('#select-template-for-preview').text($(this).text());

...
(function (AffinityDms) {
    ...
    (function (Entities) {
        ...
        var Discourses = (function () {
            function Discourses() {
            }
            Discourses.prototype.AddAttachmentsToCommentDiv = function (AttachmentList) {
                    ...
                    for (var i = 0; i < AttachmentList.length; i++) {
                        ...
                        if (AttachmentsNode != null) {
                            for (var j = 0; j < AttachmentsNode.length; j++) {
                                var attachmentDiv = AttachmentsNode[j];
                                if (((attachmentDiv.getAttribute("data-type")) == Entities.DiscussionPostAttachmentType.Document.toString()) || ((attachmentDiv.getAttribute("data-type")) == Entities.DiscussionPostAttachmentType.External.toString()) || ((attachmentDiv.getAttribute("data-type")) == Entities.DiscussionPostAttachmentType.Template.toString()) || ((attachmentDiv.getAttribute("data-type")) == Entities.DiscussionPostAttachmentType.Form.toString())) {
                                    if ((parseInt(attachmentDiv.getAttribute("data-id"))) == currentAttachment.Id && (attachmentDiv.getAttribute("data-type")) == currentAttachment.Datatype.toString()) {
                                        if (attachmentDiv.getAttribute("data-type") == Entities.DiscussionPostAttachmentType.External.toString()) {
                                ...
                                else if (((attachmentDiv.getAttribute("data-type")) == Entities.DiscussionPostAttachmentType.Live.toString())) {
                ...
                var urlImageSrc = "../../Images/FileIcons/Link.png";
                            */
                            if (currentAttachment.Datatype == Entities.DiscussionPostAttachmentType.Document) {
                                imgsrc = "../../Images/FileIcons/Documents.png";
                            }
                            else if (currentAttachment.Datatype == Entities.DiscussionPostAttachmentType.Template) {
                                imgsrc = "../../Images/FileIcons/Template.png";
                            }
                            else if (currentAttachment.Datatype == Entities.DiscussionPostAttachmentType.Form) {
                                imgsrc = "../../Images/FileIcons/Form.png";
                            }
                            else if (currentAttachment.Datatype == Entities.DiscussionPostAttachmentType.External) {
                                imgsrc = "../../Images/FileIcons/Attachment.png";
                            }
                            else if (currentAttachment.Datatype == Entities.DiscussionPostAttachmentType.Live) {
                            ...
                            DeleteAttachment.onclick = function (event) {
            ...
            Discourses.prototype.hideDiscourseBtn = function (event) {
            ...
            Discourses.prototype.showDiscourseBtn = function (event) {
                var discourseCommentEditorId = "#discourseCommentEditor";
                var showDiscourseCommentId = "#showDiscourseComment";
                $(showDiscourseCommentId).hide();
                $(discourseCommentEditorId).show();
            };
            Discourses.prototype.CloseHistoryViewerDiv = function (event) {
                var showDiscourseCommentId = "#showDiscourseComment";
            ...
            Discourses.prototype.CloseUploadAttachmentsDiv = function (event) {
                var discourseCommentEditorId = "#discourseCommentEditor";
                var uploadAttachmentsDiv = "#uploadAttachmentsDiv";
                $(uploadAttachmentsDiv).hide();
                $(discourseCommentEditorId).show();
            };
            Discourses.prototype.AddRemoveChatUsers = function (event) {
                ...
                $("#InviteUserEmail").val("");
                var DiscourseNo_H = document.getElementById("DiscourseNo_H");
            ...
            Discourses.prototype.CloseAddRemoveChatUsersDiv = function (event) {
                $("#userManagementSuccess").hide();
                $("#userManagementError").hide();
                $("#userManagementSuccess").text("");
                $("#userManagementError").text("");
            ...
            Discourses.prototype.AddRemoveUserBtn = function (event) {
                /*
            ...
            Discourses.prototype.AddInternalInviteBtn = function (event) {
                $("#userManagementSuccess").hide();
                $("#userManagementError").hide();
                $("#userManagementSuccess").text("");
                $("#userManagementError").text("");
            ...
            Discourses.prototype.CloseUserManagementDiv = function (event) {
                $("#userManagementSuccess").hide();
                $("#userManagementError").hide();
                $("#userManagementSuccess").text("");
                $("#userManagementError").text("");
            ...
            Discourses.prototype.AddDocumentAsAttachmnet = function (id, Name) {
                var AttachmentList = new Array();
                var attachments = new Attachments();
                attachments.Id = id;
                attachments.Datatype = Entities.DiscussionPostAttachmentType.Document;
                attachments.Url = "";
            ...
            Discourses.prototype.ShowCreatePostModal = function (event) {
            ...
            Discourses.prototype.SaveDynamicSelectionModal = function () {
                var DynamicModalDataType_H = document.getElementById("DynamicModalDataType_H");
                var PostAttachmentsDiv = document.getElementById("PostAttachmentsDiv");
                var AttachmentsNode = document.getElementsByName("PostAttachements");
                var AttachmentList = new Array();
                    ...
                    if (PostAttachmentsDiv != null) {
                        if (DynamicModalDataType_H.value == "Document") {
                            ...
                            for (var i = 0; i < CheckDocumentSelection.length; i++) {
                                var ChkSelection = CheckDocumentSelection[i];
                            ...
                            for (var i = 0; i < CheckDocumentSelection.length; i++) {
                                ...
                                if (ChkSelection.checked) {
                                    ...
                                    if (uid != null) {
                                        ...
                                        var attachments = new Attachments();
                                        attachments.Id = id;
                                        attachments.Datatype = Entities.DiscussionPostAttachmentType.Template;
                                        attachments.Url = "";
                                        attachments.Name = dataname;
                                        AttachmentList.push(attachments);
                                    }
                            ...
                            for (var i = 0; i < CheckDocumentSelection.length; i++) {
                                ...
                                if (ChkSelection.checked) {
                                    ...
                                    if (uid != null) {
                                        ...
                                        var attachments = new Attachments();
                                        attachments.Id = id;
                                        attachments.Datatype = Entities.DiscussionPostAttachmentType.Form;
                                        attachments.Url = "";
                                        attachments.Name = dataname;
                                        AttachmentList.push(attachments);
                                    }
                            ...
                            for (var i = 0; i < CheckDocumentSelection.length; i++) {
                                ...
                                if (ChkSelection.checked) {
                                    ...
                                    if (uid != null) {
                                        ...
                                        var attachments = new Attachments();
                                        attachments.Id = id;
                                        attachments.Datatype = Entities.DiscussionPostAttachmentType.External;
                                        attachments.Url = "";
                                        attachments.Name = dataname;
                                        AttachmentList.push(attachments);
                                    }
                            ...
                            var DynamicModalLiveTextBox = document.getElementById("DynamicModalLiveTextBox");
                            if (DynamicModalLiveTextBox != null) {
                                if (DynamicModalLiveTextBox.value != null || DynamicModalLiveTextBox.value != "") {
                                    var attachments = new Attachments();
                                    attachments.Id = 0;
                                    attachments.Datatype = Entities.DiscussionPostAttachmentType.Live;
            ...
            Discourses.prototype.SetExterFilesAsAttachments = function (fileName) {
            ...
            Discourses.prototype.ViewCommentHistory = function (event) {
                var inputelemenet = null;
                if (event.currentTarget instanceof HTMLInputElement) {
                    inputelemenet = event.currentTarget;
                }
            ...
            //    }
            //}
            Discourses.prototype.SaveUserSelectionModal = function (event) {
                var DiscourseNo_H = document.getElementById("DiscourseNo_H");
                if (DiscourseNo_H != null) {
                    var SelectedUsersList = new Array();
                    var SelectedUsersName = new Array();
                    var SelectedUsers = document.getElementsByName("CheckUserSelection");
                                ...
                                success: function (response) {
                                    try {
                                        if (typeof (response) == "boolean") {
                                            var DiscourseAddedUsersDiv = document.getElementById("DiscourseAddedUsers");
            ...
            Discourses.prototype.PostComment = function (event) {
                var editbtn;
            ...
            //    }
            //}
            Discourses.prototype.ResetCommentBox = function (event) {
                var editor = $("#CommentTextEditor").data("kendoEditor");
                var plaincomment = $("#value").val();
                var editorcomment = editor.value("");
                var PostAttachmentsDiv = document.getElementById("PostAttachmentsDiv");
                ...
                postCommentBtn.style.display = "";
                var postEditedCommentBtn = document.getElementById("postEditedCommentBtn");
                postEditedCommentBtn.style.display = "none";
                postEditedCommentBtn.setAttribute("data-id", "-1");
                var PostTitleTxt = document.getElementById("PostTitleTxt");
            ...
            Discourses.prototype.GetMonth = function (month) {
            ...
            Discourses.prototype.getDocumentList = function () {
                var DynamicModalRowId_H = document.getElementById("DynamicModalRowId_H");
            ...
            Discourses.prototype.getTemplateList = function () {
                var DynamicModalRowId_H = document.getElementById("DynamicModalRowId_H");
                if (DynamicModalRowId_H != null) {
                    DynamicModalRowId_H.textContent = "";
                }
                $("#DynamicModal").find(".modal-body").load("/TenantDiscourse/GetAllTemplatesForDiscourse?templateType=" + Entities.TemplateType.Template);
            };
            Discourses.prototype.getFormList = function () {
                var DynamicModalRowId_H = document.getElementById("DynamicModalRowId_H");
                if (DynamicModalRowId_H != null) {
                    DynamicModalRowId_H.textContent = "";
                }
                $("#DynamicModal").find(".modal-body").load("/TenantDiscourse/GetAllTemplatesForDiscourse?templateType=" + Entities.TemplateType.Form);
            };
            Discourses.prototype.getExternal = function () {
                //alert("external");
            };
            Discourses.prototype.getLive = function () {
            ...
            Discourses.prototype.ShowDynamicModal = function (event) {
                if (event.currentTarget instanceof HTMLAnchorElement) {
                            ...
                            if (uploadAttachmentsHeader != null && uploadAttachmentsContainer != null) {
                                switch (datatype) {
                                    ...
                                    case "Template":
                                        ...
                                        $("#showDiscourseComment").hide();
                                        $("#discourseCommentEditor").hide();
                                        $("#uploadAttachmentsContainer").load("/TenantDiscourse/GetAllTemplatesForDiscourse?templateType=" + Entities.TemplateType.Template);
                                        break;
                                    case "Form":
                                        //  DynamicModalRowId_H.value = "TenantTemplatesSelectionListGrid";//ListGridID
                                        ...
                                        $("#showDiscourseComment").hide();
                                        $("#discourseCommentEditor").hide();
                                        $("#uploadAttachmentsContainer").load("/TenantDiscourse/GetAllTemplatesForDiscourse?templateType=" + Entities.TemplateType.Form);
                                        break;
                                    case "External":
            ...
            Discourses.prototype.ShowExternalDocumentModal = function (event) {
                if (event.currentTarget instanceof HTMLAnchorElement) {
                    var CurrentElement = event.currentTarget;
                    if (CurrentElement != null) {
                        var datatype = CurrentElement.getAttribute("data-type");
                        if (datatype != null) {
                            var DynamicModalDataType_H = document.getElementById("DynamicModalDataType_H");
                            DynamicModalDataType_H.value = datatype;
                            var DocumentUploadModal = $("#DocumentUploadModal");
                            DocumentUploadModal.modal("show");
                        }
                    }
                }
            };
            Discourses.prototype.CreatePost = function (event) {
                var editor = $("#CommentTextEditor").data("kendoEditor");
                var plaincomment = $("#value").val();
                ...
                if (AttachmentsNode != null) {
                    if (AttachmentsNode.length) {
                        for (var i = 0; i < AttachmentsNode.length; i++) {
                            var attachment = AttachmentsNode[i];
                            ...
                            if (attachmentType != null) {
                                switch (attachmentType) {
                                    case Entities.DiscussionPostAttachmentType.Document.toString():
                                        ...
                                        break;
                                    case Entities.DiscussionPostAttachmentType.Template.toString():
                                        ...
                                        break;
                                    case Entities.DiscussionPostAttachmentType.Form.toString():
                                        var tempId = parseInt(attachmentid);
                                        if (tempId != null) {
                                            if (tempId > 0) {
                                                templateList.push(tempId);
                                        ...
                                        break;
                                    case Entities.DiscussionPostAttachmentType.External.toString():
                                        ...
                                        //}
                                        break;
                                    case Entities.DiscussionPostAttachmentType.Live.toString():
                ...
                if (PostTitleTxt != null) {
                    ...
                    if (((editorcomment != null) || (documentList.length > 0) || (templateList.length > 0) || (externalList.length > 0) || (liveList.length > 0)) && (PostTitleTxt.value != null || PostTitleTxt.value != "")) {
                        ...
                        var DiscourseNewUsersInviteList = new Array();
                        ...
                        var DiscourseNewEmailInviteList = new Array();
                            ...
                            success: function (response) {
                                try {
                                    if (response.search("Exception:: ") != -1) {
                                        ...
                                        var IsDiscourseModal = document.getElementById("IsDiscourseModal");
                                        var IsDiscourseDocumentCreatePostModal = document.getElementById("IsDiscourseDocumentCreatePostModal");
            ...
            Discourses.prototype.DeleteCommentAttachment = function (event) {
            ...
            //    }
            //}
            Discourses.prototype.EditComment = function (event) {
                ...
                if (postEditedCommentBtn != null) {
                    ...
                    if (id > 0) {
                        var PostComment = document.getElementById(postId);
                        var editor = $("#CommentTextEditor").data("kendoEditor");
                        if (PostComment != null) {
                            if (PostComment.innerHTML != null) {
                                var editorcomment = editor.value(PostComment.innerHTML);
            ...
            Discourses.prototype.SendExternalUserInvite = function (event) {
                try {
                    var DiscourseNo_H = document.getElementById("DiscourseNo_H");
                    if (DiscourseNo_H != null) {
                        ...
                        if (InviteUserEmail != null) {
                            if (InviteUserEmail.value != "") {
                                if ((parseInt(DiscourseNo_H.value)) > 0) {
                                    ...
                                    var DiscourseAddedUsersDiv = document.getElementById("DiscourseAddedUsers");
                                    if (DiscourseAddedUsersDiv != null) {
                                        var MailCounter_H = document.getElementById("MailCounter_H");
            ...
            //    }
            //}
            Discourses.prototype.createNode = function (text) {
            ...
            Discourses.prototype.copyNode = function (node) {
            ...
            //    }, 5000);
            //}
            Discourses.prototype.SetPostAttachmentToAttachmentsDiv = function (postcounter, commentType) {
                                ...
                                if (PostAttachments.childNodes[k] instanceof HTMLSpanElement) {
                                    ...
                                    for (var l = 0; l < spanElement.childNodes.length; l++) {
                                        if (spanElement.childNodes[l] instanceof HTMLAnchorElement) {
                                            var anchor = spanElement.childNodes[l];
                                            var dataid = parseInt(anchor.getAttribute("data-id"));
                                            var datatype = anchor.getAttribute("data-type");
                                            var dataurl = anchor.getAttribute("data-url");
                                            var dataname = anchor.getAttribute("data-name");
            ...
            Discourses.prototype.PostEditedComment = function (event) {
                var target;
                if (event instanceof Event) {
            ...
            Discourses.prototype.ProccessComment = function (target, isEdited) {
                var DiscourseNo_H = document.getElementById("DiscourseNo_H");
                if (DiscourseNo_H != null) {
                    var editor = $("#CommentTextEditor").data("kendoEditor");
                    var plaincomment = $("#value").val();
                    ...
                    var templateList = new Array();
                    var externalList = new Array();
                    var existingExternalList = new Array();
                    var liveList = new Array();
                    if (AttachmentsNode != null) {
                        if (AttachmentsNode.length) {
                            for (var i = 0; i < AttachmentsNode.length; i++) {
            ...
            Discourses.prototype.EditTitleComment = function (event) {
                var postCommentBtn = document.getElementById("postCommentBtn");
                AffinityDms.Entities.Discourses.prototype.ResetCommentBox(null);
                var TitleInputDiv = document.getElementById("TitleInputDiv");
                if (TitleInputDiv != null) {
                    var editbtn;
                    if (event instanceof Event) {
                        editbtn = event.currentTarget;
                    ...
                    if (editbtn.getAttribute("data-counter") != null) {
                        var postcounter = parseInt(editbtn.getAttribute("data-counter"));
                        var EditCounter_H = document.getElementById("EditCounter_H");
                        var EditPost_H = document.getElementById("EditPost_H");
                        if (EditCounter_H != null && EditPost_H != null) {
                            EditCounter_H.value = postcounter.toString();
                            if (editbtn.getAttribute("data-id") != null) {
                                var postId = parseInt(editbtn.getAttribute("data-id"));
                                if (postId > 0) {
                                    ...
                                    var PostComment = document.getElementById("PostComment_" + postcounter);
                                    var editor = $("#CommentTextEditor").data("kendoEditor");
                                    if (PostComment != null) {
                                        if (PostComment.innerHTML != null) {
                                            var editorcomment = editor.value(PostComment.innerHTML);
            ...
            Discourses.prototype.OnInviteTextChange = function (e) {
                //$("#InviteUrlHolder").show();
                ////node.value = text;
                //document.querySelector("#InviteUrlHolderText");
                //$("#InviteUrlHolderText").select();
        ...
        Entities.Discourses = Discourses;
...
//# sourceMappingURL=Discourses.js.map
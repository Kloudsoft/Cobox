...
declare module lt.Controls {
   ...
   interface InterpolationEventHandler {
   ...
   class ImageViewer {
      ...
      set_ownerDraw(value: boolean): void;
      ...
      getItemImageTransformScaleOnly(item: ImageViewerItem): lt.LeadMatrix;  // protected
      ...
      maximumScrollSize: lt.LeadSizeD; // read-only
   ...
   interface ImageViewerImageLoadingEventHandler {
   ...
   class ImageViewerCreateOptions {
      ...
      get_parentDiv(): HTMLDivElement;
      set_parentDiv(value: HTMLDivElement): void;
   ...
   interface ImageViewerRenderEventHandler {
   ...
   interface ImageViewerItemChangedEventHandler {
   ...
   interface ImageViewerItemErrorEventHandler {
   ...
   interface ImageViewerItemDragDropEventHandler {
   ...
   class ImageViewerItemDragDropEventArgs extends lt.LeadEventArgs {
      ...
      targetItem: ImageViewerItem; // read-only
      effect: string;
      format: string; // read-only
      abort: boolean;
   }

   interface ImageViewerElementsUpdatedEventHandler {
   ...
   interface ImageViewerRubberBandEventHandler {
   ...
   interface ImageViewerSpyGlassDrawImageEventHandler {
   ...
   interface InteractiveDragStartedEventHandler {
   ...
   class InteractiveDragStartedEventArgs extends InteractiveEventArgs {
   ...
   interface InteractiveDragDeltaEventHandler {
   ...
   class InteractiveDragDeltaEventArgs extends InteractiveEventArgs {
   ...
   interface InteractiveDragCompletedEventHandler {
   ...
   class InteractiveDragCompletedEventArgs extends InteractiveEventArgs {
      get_direction(): InteractiveDirection;
      set_direction(value: InteractiveDirection): void;
      get_change(): lt.LeadPointD;
      set_change(value: lt.LeadPointD): void;
   ...
   interface InteractiveKeyEventHandler {
   ...
   interface InteractiveMultiTouchEventHandler {
   ...
   interface InteractivePinchStartedEventHandler {
   ...
   interface InteractivePinchDeltaEventHandler {
   ...
   interface InteractivePinchCompletedEventHandler {

...
var g=(f&&q<f)||d&&(q>d);
if(q<=0||g||($telerik.isIE7&&q<=this._column._correctWidthForIE())||(m>=this._ownerElement.offsetWidth&&this._column._owner._clientSettings._resizing._resizeMode!=Telerik.Web.UI.TreeListResizeMode.AllowScroll)){this._rightResizer.style.left=l;
return;

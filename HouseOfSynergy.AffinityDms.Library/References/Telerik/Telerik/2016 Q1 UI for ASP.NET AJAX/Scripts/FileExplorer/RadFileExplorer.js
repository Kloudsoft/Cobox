...
this._fileList.add_itemSelect(Function.createDelegate(this,function(n,m){this._updateToolbar(null,null,m.get_item().get_permissions());
this.raise_itemSelected(m.get_item());
}));
...
if(n){var m=n.getActiveWindow();
if(m){m.close("SenderIsBtnUpload");
...
var o=this._setContextMenuItemsState(n,this.get_currentPermissions(this._selectedFileListItem.Path));

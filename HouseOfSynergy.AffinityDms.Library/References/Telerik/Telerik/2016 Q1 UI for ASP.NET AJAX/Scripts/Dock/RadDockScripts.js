...
u<q.length;
u++){if(q[u]!=s){q[u].dragLeaveTarget(this);
}else{s.hitTest(this,p,true);
}}}return s;
...
var n=(p!=null);
if(n){var r={position:q.style.position,top:q.style.top,left:q.style.left};
...
q.style.left=r.left;
q.parentNode.removeChild(q);
var t=this.get_dockZone();
if(t&&Telerik.Web.UI.RadDockZone.isInstanceOfType(t)){o.insertBefore(q,t._placeholder);
...
if(!q||n==0){this._onCloseAnimationEnd();
return;

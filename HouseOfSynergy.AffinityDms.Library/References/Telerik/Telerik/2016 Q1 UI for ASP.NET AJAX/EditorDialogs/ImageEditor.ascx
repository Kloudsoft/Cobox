...
<div>
	...
	<telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
		<telerik:RadImageEditor ID="RadImageEditor1" runat="server" Height="450" Width="700" EnableResize="false" >
			<Tools>
...
<table id="ImageEditorSaveOptions" cellpadding="0" cellspacing="0" style="width: 100%;padding: 10px 0 5px 0;">
	<tr>

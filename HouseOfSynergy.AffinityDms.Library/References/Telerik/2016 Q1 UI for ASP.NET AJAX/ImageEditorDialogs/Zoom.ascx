	...
	<tr>
		<td colspan="2">
			<telerik:RadButton ID="btnActualSize" runat="server" ToolTip="Actual Size" AutoPostBack="false"
				CausesValidation="false" EnableViewState="false" CommandName="ActualSize" Width="22px"
			...
			<telerik:RadButton ID="btnFitImage" runat="server" ToolTip="Best Fit" AutoPostBack="false"
				CausesValidation="false" EnableViewState="false" CommandName="BestFit" Width="22px"
				Style="margin-left: 7px;" CssClass="rieZIndex_IE9">
				<Icon PrimaryIconCssClass="rieBestFit" PrimaryIconTop="4px" PrimaryIconLeft="4px" />
			</telerik:RadButton>

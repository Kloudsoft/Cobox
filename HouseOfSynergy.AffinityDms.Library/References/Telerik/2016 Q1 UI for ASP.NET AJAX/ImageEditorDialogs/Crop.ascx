			...
			<div class="rieResizeButtons">
				<telerik:RadButton ID="btnConstraint" runat="server" ToolTip="Constrain Proportions"
					...
					<ToggleStates>
						...
						<telerik:RadButtonToggleState PrimaryIconCssClass="rieRemoveConstrainBtn" PrimaryIconTop="3px" />
					</ToggleStates>
				</telerik:RadButton>
				<telerik:RadButton ID="btnSwap" runat="server" ToolTip="Swap Values" AutoPostBack="false"
					...
					<Icon PrimaryIconCssClass="rieSwapValues" PrimaryIconTop="6px" PrimaryIconLeft="4px" />
				</telerik:RadButton>
			</div>
		</td>
	</tr>

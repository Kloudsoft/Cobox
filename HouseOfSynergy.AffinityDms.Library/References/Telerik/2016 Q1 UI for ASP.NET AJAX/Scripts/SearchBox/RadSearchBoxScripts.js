...
if(J>0){L=J-(I+H+K);
a(this.get_childListElement()).css("height",L);
...
},get_dropDownElement:function(){if(!this._dropDownElement){this._dropDownElement=a(this._element).find(i+n).not(i+x).get(0);

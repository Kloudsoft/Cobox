...
if(0&&($telerik.isIE7||$telerik.isIE8)){a(this._volumeControl.get_element().parentNode).appendTo(this._jwrapper);
...
if(1||!$telerik.isIE7&&!$telerik.isIE8){this._jvcButton.parent().on("mouseenter",a.proxy(this._onVolumeControlButtonHover,this));
...
this._jplayButton[0].title="Pause";
...
this._jplayButton[0].title="Play";
...
this._progressRailTrack=$get("RadSliderTrack_"+this._progressRail.get_id());
if(1||!$telerik.isIE7&&!$telerik.isIE8){this._progressRailTrack.insertBefore(this._progressTooltip,d);

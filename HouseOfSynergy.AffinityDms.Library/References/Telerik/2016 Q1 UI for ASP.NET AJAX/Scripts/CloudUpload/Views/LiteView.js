...
m._cssClasses={_rcuIcon:"radIcon"};
...
var k=a(m),o="<span class='"+e+"'>"+n.get_localization().DropZone+"</span>",l=a("<div> <div class='rcuDropZoneInner'><span class='radIcon'></span>"+o+"</div></div>");

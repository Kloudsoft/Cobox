...
if(d._owner._renderMode==Telerik.Web.UI.RenderMode.Lite){d._expandCollapseButton.className+=" rtlActionButton";
d._expandCollapseButton.querySelector("span").className="rtlIcon rtlExpandIcon";
...
if(d._owner._renderMode==Telerik.Web.UI.RenderMode.Lite){d._expandCollapseButton.className+=" rtlActionButton";
d._expandCollapseButton.querySelector("span").className="rtlIcon rtlCollapseIcon";
...
}if($telerik.isIE8){o.style.position="absolute";
window.setTimeout(function(){o.style.position="";
},0);

...
h.scrollLeft(n,this.get_scrollLeft());
...
if(!this.get_readOnly()){n.push("append");
...
var o=a.map(this.get_viewsData(),function(p){return a.extend(true,{},n[p.type],p);
});
return o;
...
var o=["_createTask","_updateTask","_removeTask","_createDependency","_removeDependency","_createAssignment","_updateAssignment","_removeAssignment"];
var n=a(o).filter(function(r){return p[r];
});
a(n).each(function(s,r){var u=q._widget;
var t=u[r];
q._widget[r]=function(){u.dataSource.transport.set_postback(true);
if(u.dependencies.transport.set_postback){u.dependencies.transport.set_postback(true);
}if(u.assignments.dataSource.transport.set_postback){u.assignments.dataSource.transport.set_postback(true);

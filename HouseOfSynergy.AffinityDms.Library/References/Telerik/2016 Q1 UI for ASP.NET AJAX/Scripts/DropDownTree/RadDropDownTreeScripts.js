...
},set_enableDirectionDetection:function(I){this._enableDirectionDetection=I;
if(this._dropDown){this._dropDown.set_enableDirectionDetection(I);
...
L.outerHeight(O);
}if(this._cashedScrollTop){L.scrollTop(this._cashedScrollTop);

module AffinityDms.Entities {
    ...
    export enum ResizeAxis {
        None,
        Horizontal,
        HorizontalForwardOnly,
        HorizontalBackwardOnly,
        Vertical,
        VerticalUpwardOnly,
        VerticalDownwardOnly,
        All,
    }
    ...
    export class ElementProperties {
        public DisplayProperties(ImgUploader: boolean, AddColumn: boolean, ElementDataType: boolean, Name: boolean, Description: boolean, Text: boolean, X: boolean, Y: boolean, X2: boolean, Y2: boolean, Radius: boolean, Diameter: boolean, Width: boolean, Height: boolean, DivX: boolean, DivY: boolean, DivWidth: boolean, DivHeight: boolean, MinHeight: boolean, MinWidth: boolean, ForegroundColor: boolean, BackGroundColor: boolean, Hint: boolean, MinChar: boolean, MaxChar: boolean, DateTime: boolean, FontName: boolean, FontSize: boolean, FontStyle: boolean, FontColor: boolean, BorderStyle: boolean, BarcodeType: boolean, Value: boolean, ElementIndexType: boolean, SizeMode: boolean, IsSelected: boolean, Discreminator: boolean, FontGraphicsUnit: boolean, ElementMobileOrdinal: boolean, ElementIndexDataType: boolean): any {
            ...
            if (Text == true) {
                ...
                if (DivElement.getAttribute("data-Tool") == ElementType.Textbox.toString()) {
                    AddText.value = DivElement.textContent;
                }
                else if (DivElement.getAttribute("data-Tool") == ElementType.Radio.toString() || DivElement.getAttribute("data-Tool") == ElementType.Checkbox.toString()) {
                    AddText.value = DivElement.childNodes[0].textContent;
                }
                else if (DivElement.getAttribute("data-Tool") == ElementType.Barcode2D.toString()) {
                    AddText.value = DivElement.getAttribute("data-BarcodeText");
                }
                else if (DivElement.getAttribute("data-Tool") == ElementType.Label.toString()) {
                    AddText.value = DivElement.childNodes[0].textContent;
                }
    ...
    export class FormTestDesigner {
        ...
        public DragOffsetFix(ui: any, scale: number): Array<number> { //// ui = JQueryUI.DraggableEventUIParams
            ...
            return (new Array<number>(newTop, newLeft));
        }
        public ResizeOffsetFix(ui: any, scale: number): Array<number> {
            ...
            return (new Array<number>(newWidth, newHeight));
        }
        public CreateElement(id: string, appendTo: string, classList: Array<string>, styleStr: string, attributes: Array<KeyValue>, childElements: Array<HTMLElement>, width: string, height: string, left: string, top: string, X: string, Y: string, isDraggable: boolean, IsResizable: boolean, resizeAxis: ResizeAxis, elementType: ElementType) {
            
            var resizeHandles: string = "all";
            ...
            //////////    IsResizable = false;
            //////////}
            var tempType = <HTMLInputElement>document.getElementById("TempType");
            var containment = "";//"div" + appendTo;
            if (tempType.value == "Template") {
                if (elementType != ElementType.TableColumn) {
            ...
            if (isDraggable) {
                newElementDiv.draggable({
                                ...
                                var TemplateImage = <HTMLImageElement>document.getElementById("TemplateImage");
            ...
            if (IsResizable)
            {
                newElementDiv.resizable({
                                    ...
                                    autoHide: true,
                                    containment: containment,
                                    minWidth: 15,//-($(this).width()) * 10,  // these need to be large and negative
                                    minHeight: 15,//-($(this).height()) * 10, // so we can shrink our resizable while scaled
                                    resize: function (event, ui) {
                                        ...
                                        if (currentElement.getAttribute("data-tool") == ElementType.Table.toString()) {
                                            var offset = 0;
                                        ...
                                        else if (currentElement.getAttribute("data-tool") == ElementType.TableColumn.toString()) {
                                            ...
                                            for (var i = 0; i < parentElement.childNodes.length; i++) {
                                                ...
                                                if ((!(tbleCol.classList.contains("ui-resizable-handle"))) && (currentElement.id != (<HTMLElement>parentElement.childNodes[i]).id)) {
                                                    offset += (parseInt(tbleCol.style.width.replace("px", "")));
                                                    offset += ($(tbleCol.id).outerWidth() - $(tbleCol.id).innerWidth())
                                                }
                                            }
                                            ...
                                            if (tempType.value == "Template") {
                                                ...
                                                if (TemplateImage != null) {
                                                    ...
                                                    //{
                                                    //    if ((newSize[0] + event.target.offsetLeft) < TemplateImage.offsetWidth) {
                                                    //        ui.size.width = newSize[0] * scale;//TemplateImage.width - event.target.offsetLeft;
                                                    //    }
                                                    //    else {
                                                    //        ui.size.width = newSize[0];
                                                    //    }
                ...
                //            var idd = appendTo.replace("#", "");
                //            idd = idd.replace(".", "");
                //            var parentTableDiv: HTMLDivElement = <HTMLDivElement>document.getElementById(idd);
                ...
                //                    }
                //                }
                //                if (offset <= parentTableDiv.clientWidth) {
                //                    var scale = AffinityDms.Entities.FormTestDesigner.prototype.GetScaleValue();
                //                    var newSize = AffinityDms.Entities.FormTestDesigner.prototype.ResizeOffsetFix(ui, scale);
                //                    ui.size.width = newSize[0];
                //                    ui.size.height = newSize[1];
        ...
        public OnDrop(event: any) {
            ...
            if (this._dragging != false && this._elementId != "") {
                if (this._elementId == "DivToolLabel") {
                    ...
                    var attributeArray = new Array<KeyValue>();
                    ...
                    attributeKeyVal.value = ElementType.Label.toString();
                    attributeArray.push(attributeKeyVal);
                    attributeKeyVal = new KeyValue();
                    ...
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "auto", "auto", this.GetLeft(event), this.GetTop(event), "", "", true, false, ResizeAxis.None, ElementType.Label);
                    this._dragging = false;
                    this._elementId = "";
                    ...
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Tool";
                    attributeKeyVal.value = ElementType.Textbox.toString();
                    attributeArray.push(attributeKeyVal);
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Ordinal";
                    attributeKeyVal.value = divcounter.value;
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "200px", "35px", this.GetLeft(event), this.GetTop(event), "", "", true, false, ResizeAxis.Horizontal, ElementType.Textbox)
                    this._dragging = false;
                    this._elementId = "";
                    var countter: number = parseInt(divcounter.value);
                    divcounter.value = (countter + 1) + "";
                    ...
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Tool";
                    attributeKeyVal.value = ElementType.Textarea.toString();
                    attributeArray.push(attributeKeyVal);
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Ordinal";
                    attributeKeyVal.value = divcounter.value;
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "100px", "100px", this.GetLeft(event), this.GetTop(event), "", "", true, true, ResizeAxis.All, ElementType.Textarea)
                    this._dragging = false;
                    this._elementId = "";
                    var countter: number = parseInt(divcounter.value);
                    divcounter.value = (countter + 1) + "";
                    ...
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Tool";
                    attributeKeyVal.value = ElementType.Image.toString();
                    attributeArray.push(attributeKeyVal);
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Ordinal";
                    attributeKeyVal.value = divcounter.value;
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "100px", "100px", this.GetLeft(event), this.GetTop(event), "", "", true, true, ResizeAxis.All, ElementType.Image)
                    this._dragging = false;
                    this._elementId = "";
                    var countter: number = parseInt(divcounter.value);
                    divcounter.value = (countter + 1) + "";
                    ...
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Tool";
                    attributeKeyVal.value = ElementType.Radio.toString();
                    attributeArray.push(attributeKeyVal);
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Ordinal";
                    attributeKeyVal.value = divcounter.value;
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "auto", "auto", this.GetLeft(event), this.GetTop(event), "", "", true, true, ResizeAxis.All, ElementType.Radio)
                    this._dragging = false;
                    this._elementId = "";
                    var countter: number = parseInt(divcounter.value);
                    divcounter.value = (countter + 1) + "";
                    ...
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Tool";
                    attributeKeyVal.value = ElementType.Checkbox.toString();
                    attributeArray.push(attributeKeyVal);
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Ordinal";
                    attributeKeyVal.value = divcounter.value;
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "auto", "auto", this.GetLeft(event), this.GetTop(event), "", "", true, true, ResizeAxis.All, ElementType.Checkbox)
                    this._dragging = false;
                    this._elementId = "";
                    var countter: number = parseInt(divcounter.value);
                    divcounter.value = (countter + 1) + "";
                    ...
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Tool";
                    attributeKeyVal.value = ElementType.Circle.toString();
                    attributeArray.push(attributeKeyVal);
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Ordinal";
                    attributeKeyVal.value = divcounter.value;
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "35px", "35px", this.GetLeft(event), this.GetTop(event), "", "", true, true, ResizeAxis.All, ElementType.Circle)
                    this._dragging = false;
                    this._elementId = "";
                    var countter: number = parseInt(divcounter.value);
                    divcounter.value = (countter + 1) + "";
                    ...
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Tool";
                    attributeKeyVal.value = ElementType.HorizontalLine.toString(); // linehorizontal
                    attributeArray.push(attributeKeyVal);
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Ordinal";
                    attributeKeyVal.value = divcounter.value;
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "35px", "10px", this.GetLeft(event), this.GetTop(event), "", "", true, true, ResizeAxis.All, ElementType.HorizontalLine)
                    this._dragging = false;
                    this._elementId = "";
                    var countter: number = parseInt(divcounter.value);
                    divcounter.value = (countter + 1) + "";
                    ...
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Tool";
                    attributeKeyVal.value = ElementType.VerticalLine.toString();//"linevertical";
                    attributeArray.push(attributeKeyVal);
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Ordinal";
                    attributeKeyVal.value = divcounter.value;
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "10px", "35px", this.GetLeft(event), this.GetTop(event), "", "", true, true, ResizeAxis.All, ElementType.VerticalLine)
                    this._dragging = false;
                    this._elementId = "";
                    var countter: number = parseInt(divcounter.value);
                    divcounter.value = (countter + 1) + "";
                    ...
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Tool";
                    attributeKeyVal.value = ElementType.Rectangle.toString()
                    attributeArray.push(attributeKeyVal);
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Ordinal";
                    attributeKeyVal.value = divcounter.value;
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "35px", "35px", this.GetLeft(event), this.GetTop(event), "", "", true, true, ResizeAxis.All, ElementType.Rectangle)
                    this._dragging = false;
                    this._elementId = "";
                    var countter: number = parseInt(divcounter.value);
                    divcounter.value = (countter + 1) + "";
                    ...
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Tool";
                    attributeKeyVal.value = ElementType.Barcode2D.toString();
                    attributeArray.push(attributeKeyVal);
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Ordinal";
                    attributeKeyVal.value = divcounter.value;
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "100px", "100px", this.GetLeft(event), this.GetTop(event), "", "", true, true, ResizeAxis.All, ElementType.Barcode2D)
                    this._dragging = false;
                    this._elementId = "";
                    var countter: number = parseInt(divcounter.value);
                    divcounter.value = (countter + 1) + "";
                    ...
                    //attributeKeyVal.value = "Barcode2D";
                    //attributeArray.push(attributeKeyVal);
                    var childArray: Array<HTMLElement> = null;
                    //var imgfield = document.createElement("img");
                    //imgfield.style.width = "100%";
                    //imgfield.style.height = "100%";
                    //imgfield.style.opacity = "1";
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "100px", "100px", this.GetLeft(event), this.GetTop(event), "", "", true, true, ResizeAxis.All, ElementType.Rectangle)
                    this._dragging = false;
                    this._elementId = "";
                    var countter: number = parseInt(divcounter.value);
                    divcounter.value = (countter + 1) + "";
        ...
        public OnElementClick(event): void {
            ...
            this.divelement = <HTMLDivElement>document.getElementById(id);
            if (this.divelement.getAttribute("data-tool") != ElementType.TableColumn.toString()) {
            ...
            if (this.divelement.getAttribute("data-ElementType") == "FormControl") {
                ...
                if (this.divelement.getAttribute("data-Tool")== ElementType.Label.toString()) {
                ...
                else if (this.divelement.getAttribute("data-Tool") == ElementType.Textbox.toString()) {
                ...
                else if (this.divelement.getAttribute("data-Tool") == ElementType.Radio.toString()) {
                ...
                else if (this.divelement.getAttribute("data-Tool") == ElementType.Checkbox.toString()) {
                    // var inputele: HTMLInputElement = <HTMLInputElement>this.divelement.childNodes[0];
                    //currentTargetId.value = event.currentTarget.id;
                    ElementProperties.prototype.DisplayProperties(false, false, false, true, false, true, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false, true, false, false, false, true);
                }
                else if (this.divelement.getAttribute("data-Tool") == ElementType.Textarea.toString()) {
                    //currentTargetId.value = event.currentTarget.id;
                    ElementProperties.prototype.DisplayProperties(false, false, false, true, false, false, true, true, false, false, false, false, true, true, false, false, false, false, false, false, false, false, true, false, true, false, false, false, false, false, false, false, false, true, false, false, false, false, false, true);
                }
                else if (this.divelement.getAttribute("data-Tool") == ElementType.Image.toString()) {
                    //currentTargetId.value = event.currentTarget.id;
                ...
                else if (this.divelement.getAttribute("data-Tool") == ElementType.Barcode2D.toString()) {
                    //currentTargetId.value = event.currentTarget.id;
                ...
                else if (this.divelement.getAttribute("data-Tool") == ElementType.HorizontalLine.toString()) {
                    //currentTargetId.value = event.currentTarget.id;
                ...
                else if (this.divelement.getAttribute("data-Tool") == ElementType.VerticalLine.toString()) {
                    //currentTargetId.value = event.currentTarget.id;
                    ElementProperties.prototype.DisplayProperties(false, false, false, true, false, false, true, true, false, false, false, false, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, true);
                }
                else if (this.divelement.getAttribute("data-Tool") == ElementType.Rectangle.toString()) {
                    //currentTargetId.value = event.currentTarget.id;
                    ElementProperties.prototype.DisplayProperties(false, false, false, true, false, false, true, true, false, false, false, false, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, true);
                }
                else if (this.divelement.getAttribute("data-Tool")== ElementType.Circle.toString()) {
                    //currentTargetId.value = event.currentTarget.id;
                    ElementProperties.prototype.DisplayProperties(false, false, false, true, false, false, true, true, false, false, false, false, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, true);
                }
                //}
                ...
                if (this.divelement.getAttribute("data-Tool") == ElementType.Rectangle.toString()) { //rectangle should be changed to enums
                    //currentTargetId.value = event.currentTarget.id;
                    ElementProperties.prototype.DisplayProperties(false, false, false, true, false, false, true, true, false, false, false, false, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, true);
                }
            }
        ...
        public onSubmitForm(event): void {
            ...
            var ElementArray: Array<AffinityDms.Entities.TemplateElement> = AffinityDms.Entities.FormTestDesigner.prototype.CreateArrayOfElements();
            if (ElementArray.length <= 0) {
                alert("No Elements to Save");
            }
            else {
                var ExElementDetailsArray: Array<TemplateElementDetailViewModel> = AffinityDms.Entities.FormTestDesigner.prototype.CreateArrayOfElementDetails();
            ...
            for (var i = 0; i < divPage.childNodes.length; i++) {
                ...
                if (divPage.childNodes[i] instanceof (HTMLDivElement)) {
                    ...
                    if (divElement.getAttribute("data-elementtype") == "FormControl") {
                        if (divElement.getAttribute("data-Tool") == ElementType.Label.toString()) {
                        ...
                        else if (divElement.getAttribute("data-Tool") == ElementType.Textbox.toString()) {
                            var calcwidth: number = (+(divElement.style.width.replace("px", "")));
                            var calcheight: number = (+(divElement.style.height.replace("px", "")));
                            var calcX: number = (+(divElement.style.left.replace("px", "")));
                            var calcY: number = (+(divElement.style.top.replace("px", "")))
                        ...
                        else if (divElement.getAttribute("data-Tool") == ElementType.Radio.toString()) {
                        ...
                        else if (divElement.getAttribute("data-Tool") == ElementType.Checkbox.toString()) {
                            var calcX: number = (+(divElement.style.left.replace("px", "")));
                            var calcY: number = (+(divElement.style.top.replace("px", "")))
                            var calcDivX = +(divElement.style.left.replace("px", ""));
                            var calcDivY = +(divElement.style.top.replace("px", ""));
                        ...
                        else if (divElement.getAttribute("data-Tool") == ElementType.Textarea.toString()) {
                        ...
                        else if (divElement.getAttribute("data-Tool") == ElementType.Image.toString()) {
                            var calcwidth: number = (+(divElement.style.width.replace("px", "")));
                            var calcheight: number = (+(divElement.style.height.replace("px", "")));
                            var calcX: number = (+(divElement.style.left.replace("px", "")));
                            var calcY: number = (+(divElement.style.top.replace("px", "")))
                        ...
                        else if (divElement.getAttribute("data-Tool") == ElementType.HorizontalLine.toString()) {
                        ...
                        else if (divElement.getAttribute("data-Tool") == ElementType.VerticalLine.toString()) {

                            elementclass = this.SetElementArray(count, templateid, divElement.id.toString(), Entities.ElementType.VerticalLine, Entities.ElementDataType.None, divElement.getAttribute("data-name").toString(), "LineDescription", "", -1, -1, -1, -1, "0", "0", (+(divElement.style.left.replace("px", ""))), (+(divElement.style.top.replace("px", ""))), divElement.style.width.replace("px", "").toString(), divElement.style.height.replace("px", "").toString(), "", "", divElement.style.color, divElement.style.backgroundColor, "", "", "", "", "", -1, -1, "", -1, -1, divElement.getAttribute("data-Value"), +(divElement.getAttribute("data-ElementIndexType")), "", -1, "", discriminator, -1, -1, -1, -1, -1, -1, -1, -1, -1, parseInt(divElement.getAttribute("data-Ordinal")), null, null);
                            count++;
                            elementsArray.push(elementclass);
                        }
                        else if (divElement.getAttribute("data-Tool") == ElementType.Rectangle.toString()) {
                        ...
                        else if (divElement.getAttribute("data-Tool") == ElementType.Circle.toString()) {
                        ...
                        //    }
                        //}
                        if (divElement.getAttribute("data-Tool") == ElementType.Rectangle.toString()) {
                        ...
                        else if (divElement.getAttribute("data-Tool") == ElementType.Table.toString()) {
        ...
        public CreateArrayOfElementDetails(): Array<TemplateElementDetailViewModel> {
            ...
            for (var i = 0; i < divPage.childNodes.length; i++) {
                ...
                if (divPage.childNodes[i] instanceof (HTMLDivElement)) {
                    var divElement: HTMLDivElement = <HTMLDivElement>divPage.childNodes[i];
                    if ((divElement.getAttribute("data-elementtype") == "OCRControl") && divElement.getAttribute("data-Tool") == ElementType.Table.toString()) {
        ...
        public editTemplateDesign(elementsviewmodel: any): void {
            ...
            for (var i = 0; i < elementsarray.length; i++) {
                ...
                if (elementsarray[i].ElementType == ElementType.Rectangle) {
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElement" + idNumber, "#DivPage", classList, styleStr, attributeArray, childArray, elementsarray[i].DivWidth + "px", elementsarray[i].DivHeight + "px", elementsarray[i].DivX + "px", elementsarray[i].DivY + "px", "", "", true, true, ResizeAxis.All, ElementType.Rectangle)
                    this._dragging = false;
                    this._elementId = "";
                    ...
                    attributeKeyVal = new KeyValue();
                    attributeKeyVal.key = "data-Tool";
                    attributeKeyVal.value = ElementType.Table.toString();
                    attributeArray.push(attributeKeyVal);
                    //attributeKeyVal = new KeyValue();
                    //attributeKeyVal.key = "data-Ordinal";
                    //attributeKeyVal.value = divcounter.value;
                    ...
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement(tempRowId, "#DivPage", classList, styleStr, attributeArray, childArray, (elementsarray[i].Width + "px"), (elementsarray[i].Height + "px"), (elementsarray[i].X + "px"), (elementsarray[i].Y + "px"), "", "", true, true, ResizeAxis.All, ElementType.Table);
                    this._dragging = false;
                    this._elementId = "";
                    this._dragging = false;
                    this._elementId = "";
                    ...
                    //////////    // var currentTargetId: HTMLInputElement = <HTMLInputElement>document.getElementById("CurTarget");
                    //////////    var parentTableDiv: HTMLDivElement = <HTMLDivElement>document.getElementById(tempRowId);
                    ...
                    //////////    attributeKeyVal = new KeyValue();
                    //////////    attributeKeyVal.key = "data-Tool";
                    //////////    attributeKeyVal.value = ElementType.TableColumn.toString()
                    //////////    attributeArray.push(attributeKeyVal);
                    //////////    attributeKeyVal = new KeyValue();
                    //////////    attributeKeyVal.key = "data-name";
                    //////////    attributeKeyVal.value = elementsarray[i].Name;
        ...
        private editTemplateTableColumns(elementdetailsarray: TemplateElementDetail[], tempRowId: string): void
        {
            for (var j = 0; j < elementdetailsarray.length; j++) {
                var colcounter: HTMLInputElement = <HTMLInputElement>document.getElementById("colcounter");
                var coloumncounter = 0;
                ...
                var classList = new Array<string>();
                classList.push("ui-resizable");
                AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElementColumnContainerDiv" + coloumncounter, "#"+tempRowId, classList, styleStr, attributeArray, childArray, elementdetailsarray[j].Width + "px", "100%", /*elementdetailsarray[j].X + */"0px", elementdetailsarray[j].Y + "px", "", "", false, true, ResizeAxis.HorizontalForwardOnly, ElementType.TableColumn)
                this._dragging = false;
                this._elementId = "";
                colcounter.value = (coloumncounter + 1) + "";
            }
        ...
        public createOcrZone(): any {
            ...
            var classList = new Array<string>();
            classList.push("ui-resizable");
            AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElementTempRow" + divcounter.value, "#DivPage", classList, styleStr, attributeArray, childArray, "100px", "100px", this.GetLeft(event), this.GetTop(event), "", "", true, true, ResizeAxis.All, ElementType.Table)
            this._dragging = false;
            this._elementId = "";
            var countter: number = parseInt(divcounter.value);
            divcounter.value = (countter + 1) + "";
        ...
        public AddColumnToOCRTableZone(event): any {
            ...
            if (search.toString() == "0") {
                ...
                if (offset + 10 > parentTableDiv.offsetWidth) {
                    ...
                    var classList = new Array<string>();
                    classList.push("ui-resizable");
                    AffinityDms.Entities.FormTestDesigner.prototype.CreateElement("DivElementColumnContainerDiv" + coloumncounter, "#" + currentTargetId.value, classList, styleStr, attributeArray, childArray, "10px", "100%", 0 + "px", "0px", "", "", false, true, ResizeAxis.HorizontalForwardOnly, ElementType.TableColumn)
                    this._dragging = false;
                    this._elementId = "";
                    colcounter.value = (coloumncounter + 1) + "";
        ...
        public AddText(event): any {
            ...
            else if (divelement.getAttribute("data-Tool").toLowerCase() == ElementType.Radio.toString() || divelement.getAttribute("data-Tool") == ElementType.Checkbox.toString()) {
                divelement.childNodes[0].textContent = TextElement.value;
            }
            else if (divelement.getAttribute("data-Tool") == ElementType.Barcode2D.toString()) {
        ...
        public OnFileSelected(event): any {
            ...
            filereader.addEventListener("load", (e: any) => {
                ...
                if (divelement.getAttribute("data-Tool") == ElementType.Image.toString()) {

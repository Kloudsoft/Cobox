...
{
    public class TenantFormRenderMobileController : Controller
    {
        // GET: TenantFormRenderMobile
            ...
            try
            {
                if (id > 0)
                {
                    ...
                    if (elements.Count > 0 && dbresult)
                    {
                        ...
                        return View("~/Views/Tenants/Forms/FormRenderMobile.cshtml", elementslist);
                    }
                    else
                    {
                        List<TemplateElement> elementslist = null;

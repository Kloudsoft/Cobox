...
(function (AffinityDms) {
    ...
    (function (Entities) {
        var DocumentViewer = (function () {
            ...
            DocumentViewer.prototype.run = function () {
                ...
                if (DocViewerType != null) {
                    if (DocViewerType.getAttribute("data-id") != null && DocViewerType.getAttribute("data-type") != null) {
                        ...
                        if (id > 0 && DocViewerType.getAttribute("data-type") != "") {
                            var type = Entities.DiscussionPostAttachmentType.None;
                            switch (DocViewerType.getAttribute("data-type")) {
                                case "Document":
                                    {
                                        type = Entities.DiscussionPostAttachmentType.Document;
                                        break;
                                    }
                                case "External":
                                    {
                                        type = Entities.DiscussionPostAttachmentType.External;
                                        break;
                                    }
                                default:
                                    break;
            ...
            DocumentViewer.prototype.LoadDocument = function (url, serviceHost, servicePath, apiPath) {
            ...
            DocumentViewer.prototype.docViewerUrlSearch = function (event) {
                this.run();
            };
            return DocumentViewer;
        }());
        Entities.DocumentViewer = DocumentViewer;
        var Dialogs;
        (function (Dialogs) {
